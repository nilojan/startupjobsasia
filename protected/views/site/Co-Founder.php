...
<div class="clear">
	<h1 class="HomeLatestJobs">Co-Founder Jobs</h1>
</div>
...
<?php
        ...
        $dataProvider=new CActiveDataProvider('job', array( 'criteria'=>array(
                                                                    'order'=>'created DESC',
                                                                    'condition'=>'expire >= :today AND co_founder=:type2 AND status = 1',
                                                                    'params'=>array('today'=>date('Y-m-d H:i:s'),':type2'=>'Co-founder'),
                                                                    ),
