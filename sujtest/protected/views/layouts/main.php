...
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/js/company_theme.js"></script>
...
<div class="container" id="page">
	...
	<div class="row-fluid">
        ...
        array('label'=>'as Job Seeker', 'url'=>array('/user/registration')),
                    // '---',
        array('label'=>'as StartUp', 'url'=>array('/company/registration')),
...
<?php
	...
	<?php } else
		// if((Yii::app()->user->isMember()) || if(Yii::app()->user->isGuest()))
	{ ?>
	<div class="clear">
