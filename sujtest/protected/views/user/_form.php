...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php //echo $form->textFieldRow($model,'edu_1',array('class'=>'span3','maxlength'=>250)); ?>
	<?php //echo $form->textFieldRow($model,'edu_2',array('class'=>'span3','maxlength'=>250)); ?>
 ...
 <div id="p_scents">
	 	...
	 	if ($size > 1)
	 	{
		 	for($i=0;$i<$size;$i++)
		 	{
		 		...
		 		<p>
        			<label for="p_scnts_w"><input type='text' value='<?php echo $temp[$i]; ?>' name='p_scnt[]' placeholder='Masters,graduation,school etc...'></label>
    			</p>
	<?php }
	}
	else{ ?>
				<p>
        			<label for="p_scnts_w"><input type='text' value='<?php echo $temp[0]; ?>' name='p_scnt[]' placeholder='Masters,graduation,school etc...'></label>
   				 </p>
   	<?php
	}
...
<div id='row'>
	...
	<?php
	echo $form->labelEx($model, 'work_exp');
	?>
	
	
	<a href="#" id="addScnt_w">Add Another Input Box</a>
</div>

 <div id="p_scents_w">
	 	<?php
	 	$strign=$model->work_exp;
	 	$temp = explode(',',$strign);
	 	$size= sizeof($temp);
	 	if ($size > 1)
	 	{
		 	for($i=0;$i<$size;$i++)
		 	{
		 		...
		 		<p>
        			<label for="p_scnts_w"><input type='text' value='<?php echo $temp[$i]; ?>' name='work[]' placeholder='Past Work Experiences'></label>
   				</p>
	<?php }
	}
	else
	{ ?>
				<p>
        			<label for="p_scnts_w"><input type='text' value='<?php echo $temp[0]; ?>' name='work[]' placeholder='Past Work Experiences'></label>
   				</p>
	<?php }
	...
	<?php /*echo $form->dropDownListRow($model,'work_exp',array(''=>'Work Experience',
															...
															'5'=>'5 year',
															'6'=>'more than 5 year')); */?>
	<?php //echo $form->textFieldRow($model,'work_exp',array('class'=>'span3','maxlength'=>250))?>
	<?php //echo $form->textFieldRow($model,'work_exp_1',array('class'=>'span3','maxlength'=>250))?>
	<?php //echo $form->textFieldRow($model,'work_exp_2',array('class'=>'span3','maxlength'=>250))?>
