    ...
    public function actionUpdateStartup($id) {
      if(!(yii::app()->user->isAdmin()))
      {
        ...
        if (isset($_POST['UpdateStartupForm'])) {
                   ...
                   $CForm->password1 = $_POST['UpdateStartupForm']['password1'];
				   $CForm->password2 = $_POST['UpdateStartupForm']['password2'];
				   $CForm->password2 = $_POST['UpdateStartupForm']['password3'];
                   ...
                   $company->cemail = $CForm->cemail; 
					$company->contact = $CForm->contact;				   
                     ...
                     if ($company->save())   {
					       ...
					       $user = new user;                 
                          $user->ID = $id;
                          $user->address = $CForm->password1; // current
                          $user->contact = $CForm->password;                          
                           $user->website = $CForm->password2;
						   
						   $user->name = $CForm->name;
						   $user->email = $CForm->cemail;
