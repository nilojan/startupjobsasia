...
class Application1Controller extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Application1'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Application1');
	...
	{
		$model=new Application1('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Application1']))
			$model->attributes=$_GET['Application1'];
	...
	{
		$model=Application1::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='application1-form')
		{
